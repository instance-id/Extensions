...
namespace instance.id.Extensions
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Extensions.Format.Default)
        {
            switch (format)
            {
                case Extensions.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case Extensions.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case Extensions.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case Extensions.Format.Minimal:
                    Options.OutputTo.WriteLine(ToMinimalString());
                    break;
                case Extensions.Format.Debug:
                    Options.ToDebug(ToString());
                    break;
                case Extensions.Format.DebugMinimal:
                    Options.ToDebug(ToMinimalString());
                    break;
                case Extensions.Format.DebugMarkdown:
                    Options.ToDebug(ToMarkDownString());
                    break;
                default:
    ...
    public class ConsoleTableOptions
    {
        ...
        public void ToDebug(object log) => Debug.LogFormat(string.Format("{0}", log));
    }
